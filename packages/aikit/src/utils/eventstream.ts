...
// This class helps with that by acting like buffer data structure to manage the streams
...
export class AssistantMessageEventStream extends EventStream<Event.LLMMessageEvent, Message.AssistantMessage> {
	constructor() {
		super(
