 ...
 * than an error.
 *
 * A relative path is a disguised `process.cwd()` call: it appears in no grep, and every consumer
 ...
 * plausible answer to a question no one asked -- the same silent wrong-directory failure as T7 and
 * T10. An absolute path is the one spelling none of them can quietly reinterpret.
 *
