...
/**
 *
 * @description Placeholder for future custom filesystem implementation
 * e.g RemoteFileSystem, AWSFileSystem, etc. This is not implemented, invoking will fail.
 *
 * You really want to modify it when implementation is concrete like:
 * ```
 * const withLayer = layer.pipe(Layer.provide(CustomFileSystem.layer));
 * ```
 */
export const withLayer = Layer.effect(Service, Effect.fail(new Error("Not Implemented")));
