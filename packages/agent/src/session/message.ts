import type { Provider } from "@codework/ai";
import {
	ImageContentSchema,
	StopReasonSchema,
	TextContentSchema,
...
export namespace Message {
	...
	export const TextPart = Type.Intersect([PartBase, TextContentSchema], { $id: "TextPart" });
	export const ImagePart = Type.Intersect([PartBase, ImageContentSchema], { $id: "ImagePart" });
	export type TextPart = Static<typeof TextPart>;
	export type ImagePart = Static<typeof ImagePart>;

	export const ThinkingPart = Type.Intersect([PartBase, ThinkingContentSchema], { $id: "ThinkingPart" });
	...
	export const Assistant = Type.Intersect(
		[
			...
			Type.Object({
				...
				provider: Type.Unsafe<Provider>({ type: "string" }),
				model: Type.String(),
				usage: UsageSchema,
